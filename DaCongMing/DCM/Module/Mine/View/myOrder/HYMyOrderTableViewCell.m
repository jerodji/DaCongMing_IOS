...
- (void)setupSubviews{
    ...
    UIImageView *imgView = [[UIImageView alloc] initWithFrame:CGRectMake(10 * WIDTH_MULTIPLE, 45 * WIDTH_MULTIPLE, 55 * WIDTH_MULTIPLE, 80 * WIDTH_MULTIPLE)];
    imgView.image = [UIImage imageNamed:@"order_placeholder"];
...
- (void)layoutSubviews{
    ...
    [_orderIDLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.equalTo(@(170 * WIDTH_MULTIPLE));
